...
POKE_CONFIG = {
    "layer_start": 10,   # was 15
    "layer_end": 27,     # was 35 (Llama has 0-27, not 0-35)
    "poke_attn": True,
    "poke_mlp": False,
    "pokes": []
}
...
# LOAD MODEL
# =========================
print(f"🚀 Loading Llama 3.2300 from {MODEL_PATH}...")
...
with gr.Blocks() as demo:
    gr.Markdown("# ⚖️ T-Scan Comparator: Llama 3.2 Edition")  # was Qwen 2.5
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            with gr.Accordion("⚙️ Global Settings", open=True):
                l_start = gr.Slider(0, 27, step=1, value=10, label="Start Layer")  # was 0, 35
                l_end = gr.Slider(0, 27, step=1, value=27, label="End Layer")      # was 0, 35
