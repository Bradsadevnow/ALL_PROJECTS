            ...
            <div className="max-w-6xl mx-auto space-y-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {[
                        ...
                        { to: "/research", num: "05", title: vibe === 'brainrot' ? "BRAINROT_DEEP" : "Theory::Design", desc: vibe === 'brainrot' ? "MOGGING THE FUTURE. NO CAP. 👹" : "Guardrails, ethics, and the future of AI alignment.", tag: vibe === 'brainrot' ? "BASED_ETHICS" : "Philosophical Inquiry" }
                    ].map((proj, i) => (
                        <motion.div
                            key={proj.to}
