...
class _DPGPlaytestUI:
    ...
    def __init__(self) -> None:
        ...
        with dpg.window(tag="card_zoom_popup", show=False, no_move=True, no_scrollbar=True,
            ...
            # Image widget to display zoomed card
            placeholder_tex = dpg.add_static_texture(1, 1, (255, 255, 255))
            dpg.add_image(texture_id=placeholder_tex, tag="zoomed_card_image", width=250, height=350)
    ...
    def _refresh_hand(self) -> None:
        ...
        # Hand cards added with user_data for hover handling
        
        # No separate hover handler needed here.
    ...
    def _show_zoomed_card(self, texture_id: int) -> None:
        ...
        dpg.set_value("zoomed_card_image", texture_id)
